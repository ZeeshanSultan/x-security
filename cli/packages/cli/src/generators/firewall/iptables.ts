/**
 * iptables OUTPUT-chain rule builders for Writ's SSRF protection.
 *
...
const DEFAULT_UID = '${WRIT_APP_UID}';
...
function provenanceComment(endpoint: string, field: string, label: string): string {
  // Order matters: `# writ:` prefix is the machine-readable anchor.
 ...
 * `@@WRIT_RESOLVE:<fqdn>@@` and substitutes the current A/AAAA set
